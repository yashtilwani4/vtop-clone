...
const clearCoursesAndFaculty = async () => {
  try {
    console.log('🗑️  Clearing courses and faculty data...');
    ...
    console.log('\n🎉 Successfully cleared all courses and faculty data!');
    console.log('📋 Summary:');
